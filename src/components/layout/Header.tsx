...
const NAVY = "#071763"; // sampled from Logo_design 1 — dark logo's navy
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 px-3 sm:px-4 pt-3 sm:pt-4">
      ...
      <nav
        ...
        style={floatStyle}
      >
        {/* Logo — links to homepage; crossfades between dark/light variants
            depending on what's behind the glass navbar */}
        <a href="/" aria-label="Markition — Home" className="grid flex-shrink-0">
