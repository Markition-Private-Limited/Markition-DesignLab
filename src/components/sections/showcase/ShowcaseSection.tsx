...
const CARDS: Card[] = [
  { type: "image", src: "/assets/projects/showcase-branding.png", alt: "Brand Identity Design" },
  { type: "image", src: "/assets/projects/showcase-web.png",      alt: "Web & UI Design" },
  { type: "image", src: "/assets/projects/showcase-social.png",   alt: "Social Media Design" },
  { type: "image", src: "/assets/projects/showcase-saas.png",     alt: "SaaS Dashboard UI" },
  {
    type: "text",
  ...
  { type: "image", src: "/assets/projects/showcase-branding.png", alt: "Creative Direction" },
];
...
function TiltCard({ card, visible, index }: { card: Card; visible: boolean; index: number }) {
  ...
  /* After the fade-in settles we drop the delay so hover is instant */
