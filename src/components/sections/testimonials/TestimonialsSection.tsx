...
export function TestimonialsSection() {
  ...
  return (
    <section style={{ background: BG, padding: "64px 0 80px" }}>
      ...
      <style>{`
        .testimonials-track { animation: dl-scroll-testimonials 44s linear infinite; }
        ...
        .tc-img { transition: transform 0.50s cubic-bezier(0.4,0,0.2,1); }
        .tc-card:hover .tc-img { transform: scale(1.08); }
        .tc-play { transition: transform 0.40s cubic-bezier(0.34,1.56,0.64,1), background 0.30s ease, box-shadow 0.30s ease; }
        .tc-card:hover .tc-play {
          transform: translate(-50%, -50%) scale(1.28);
          background: rgba(255,255,255,0.32);
          box-shadow: 0 0 0 10px rgba(255,255,255,0.08), 0 0 28px rgba(255,255,255,0.25);
        }
        .tc-right { transition: background 0.30s ease; }
        .tc-card:hover .tc-right { background: rgba(240,247,255,1.0) !important; }
      `}</style>
    </section>
  );
}
